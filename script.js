    ...
    function updateDisplay() {
        ...
        const pokedexHTML = `
            ...
            <div class="pokedex-right">
                <div class="stats-panel">
                    ...
                    <div class="stat-row">
                        <span class="stat-label">✨ MEME</span>
                        <div class="stat-bar">
                            <div class="stat-fill" style="width: ${Math.min(doge.stats.meme, 100)}%"></div>
                        </div>
                        <span class="stat-value">${doge.stats.meme}</span>
                    </div>
                </div>
                    ...
                    <div class="contract-info">
                        <div class="contract-row">
                            ...
                            <span class="contract-value" onclick="copyContract()" style="cursor: pointer; font-size: 0.5em; word-break: break-all;" title="Click to copy">
                                CTUKtuWxY1cX35brrGmGv5kbbKPkQHC1isrN5gRSpump
                            </span>
                        </div>
                        <div class="contract-row">
                            <span class="contract-label">X:</span>
                            <a href="https://x.com/DogemonOnSol" target="_blank" class="twitter-link">
                                @DogemonOnSol
                            </a>
                        </div>
                    </div>
        ...
        window.showInfo = () => {
            ...
            alert(`
                ...
                Contract: CTUKtuWxY1cX35brrGmGv5kbbKPkQHC1isrN5gRSpump
        ...
        window.copyContract = () => {
            navigator.clipboard.writeText('CTUKtuWxY1cX35brrGmGv5kbbKPkQHC1isrN5gRSpump');
